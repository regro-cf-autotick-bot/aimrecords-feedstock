...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/aimrecords-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13323&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/aimrecords-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `aimrecords` can be installed with:

```
conda install aimrecords
```

It is possible to list all of the versions of `aimrecords` available on your platform with:
